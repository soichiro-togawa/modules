...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        time_veri.time_point(time_veri.t_point0)
        time_veri.time_temp()
        # Inference
        t1 = time_synchronized()
        pred = model(img, augment=opt.augment)[0]
        time_veri.time_point(time_veri.t_point1)
        ...
        time_veri.time_point(time_veri.t_point2)
    ...
    # logger.info("tall処理時間/500:{}".format((t_alle-t_alls)/500))
    # logger.info("tex1処理時間/500:{}".format(t_ex1/500))
    logger.info("t0処理時間:{}".format(time_veri.time_sum_list(time_veri.t_point0)))
    logger.info("t1処理時間:{}".format(time_veri.time_sum_list(time_veri.t_point1)))
    logger.info("t2処理時間:{}".format(time_veri.time_sum_list(time_veri.t_point2)))
    logger.info("all処理時間:{}".format(time_veri.all))
    logger.info("fps:{}".format(1/(time_veri.all/500)))
